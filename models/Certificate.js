...
const CertificateSchema = new mongoose.Schema({
  ...
  center: {
    _id: { type: mongoose.Schema.Types.ObjectId, ref: 'Center', required: false }, // ✅ FIXED: Made optional
    inst: { type: String, default: 'Online' }, // ✅ FIXED: Added default
    state: { type: String, default: 'N/A' } // ✅ FIXED: Added default
  },
  certificateType: {
    type: String,
